...
<head>
    ...
    <!-- Icon -->
    <link rel="icon" type="icon" href="assets/dist/img/konoha.png">
    <!-- Custom -->
...
<body class="hold-transition login-page" style="font-family: 'Quicksand', sans-serif;">
    <div class="login-box">
        <div class="login-logo">
            <b>PERPUSTAKAAN DIGITAL KONOHA</b>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body" style="border-radius: 15px;">
            <img src="assets/dist/img/konoha.png" height="80px" width="80px" style="display: block; margin-left: auto; margin-right: auto; margin-top: -12px; margin-bottom: 5px;">
